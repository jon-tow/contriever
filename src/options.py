...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--sampling_coefficient", type=float, default=0., 
        ...
        self.parser.add_argument('--prob_augmentation', type=float, default=0.)
        ...
        self.parser.add_argument('--lr_min_ratio', type=float, default=0., 
